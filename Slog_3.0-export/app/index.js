...
function restoreState()
{
  ...
  accelCurrLogRecordCount = (fs.statSync(accelLogFile).size / (accelRecordSize + accelRecordSize32) ) * accelConfig.batch;
  gyroCurrLogRecordCount = (fs.statSync(gyroLogFile).size / (gyroRecordSize + gyroRecordSize32)) * gyroConfig.batch;
...
function logAccel() {
  ...
  // First divide by g = 9.80665 to get it in units of g
  // Then multiply by 8192 (since the range is -4g to +4g)
  // The resulting integer would be -32768 (-4g) to +32768 (+4g)
  // Since we can't fit +32768 in 16 bits, make it +32767
  // let x = scientific.clip(
  //  scientific.mul(
  //    scientific.div(accel.readings.x, 9.80665),
  //    8192),
  //  -32768,
  //  32767);
  // let y = scientific.clip(
  //  scientific.mul(
  //    scientific.div(accel.readings.y, 9.80665),
  //    8192),
  //  -32768,
  //  32767);
  // let z = scientific.clip(
  //  scientific.mul(
  //    scientific.div(accel.readings.z, 9.80665),
  //    8192),
  //  -32768,
  //  32767);
